...
(function() {
							...
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Lista582',
										'page_location': 'https://lista.vemsambar.club/#lista582',
									});
								},
							],
						},
					...
					'promoter582': {
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Promoter582',
										'page_location': 'https://lista.vemsambar.club/#promoter582',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Bday569',
										'page_location': 'https://lista.vemsambar.club/#bday569',
									});
								},
							],
						},
					...
					'listageral': {
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Listageral',
										'page_location': 'https://lista.vemsambar.club/#listageral',
									});
								},
							],
						},
					...
					'promoters': {
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Promoters',
										'page_location': 'https://lista.vemsambar.club/#promoters',
									});
								},
							],
						},
							...
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										...
										'page_location': 'https://lista.vemsambar.club/#aniversariantes',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Drop',
										'page_location': 'https://lista.vemsambar.club/#drop',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Admin258',
										'page_location': 'https://lista.vemsambar.club/#admin258',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Menu',
										'page_location': 'https://lista.vemsambar.club/#menu',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Noparty',
										'page_location': 'https://lista.vemsambar.club/#noparty',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Script',
										'page_location': 'https://lista.vemsambar.club/#script',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Home',
										'page_location': 'https://lista.vemsambar.club',
									});
								},
							],
						},
	...
	// Icons: icons01.
		$('#icons01 > li:nth-child(1) > a').addEventListener(
			'click',
			function(event) { 
				event.preventDefault();
		...
		$('#icons01 > li:nth-child(2) > a').addEventListener(
			'click',
			function(event) { 
				event.preventDefault();
				event.stopPropagation();
		...
		$('#icons01 > li:nth-child(3) > a').addEventListener(
			'click',
			function(event) { 
				event.preventDefault();
				event.stopPropagation();
				var mostraDel = document.querySelector(".todoBtn");
				
				if (mostraDel.style.display !== 'flex') {
				
				var mostraDelete = document.querySelectorAll(".todoBtn");
				for (var i = 0, j = mostraDelete.length; i < j; i++) {
				mostraDelete[i].style.display= "flex";
				};
				
				document.querySelector('#icons01 > li:nth-child(3) > a > svg').style.fill = "#FF0000";
				
				} else {
				
				var mostraDelete= document.querySelectorAll(".todoBtn");
				for (var i = 0, j = mostraDelete.length; i < j; i++) {
				mostraDelete[i].style.display= "none";
				};
				
				document.querySelector('#icons01 > li:nth-child(2) > a > svg').style.fill = "#FFFFFF50";
				
				document.querySelector('#icons01 > li:nth-child(3) > a > svg').style.fill = "#FFFFFF50";
	...
	// Buttons: buttons15.
		$('#buttons15 > li:nth-child(1) > a').addEventListener(
			'click',
			function(event) { 
				event.preventDefault();
				event.stopPropagation();
	...
	// Buttons: buttons18.
		$('#buttons18 > li:nth-child(1) > a').addEventListener(
			'click',
			function(event) { 
				event.preventDefault();
				event.stopPropagation();
	...
	// Buttons: buttons13.
		$('#buttons13 > li:nth-child(1) > a').addEventListener(
			'click',
			function(event) { 
				event.preventDefault();
				event.stopPropagation();
	...
	// Buttons: convida.
		$('#convida > li:nth-child(1) > a').addEventListener(
			'click',
			function(event) { 
				event.preventDefault();
				event.stopPropagation();
	...
	// Buttons: buttons17.
		$('#buttons17 > li:nth-child(1) > a').addEventListener(
			'click',
			function(event) { 
				document.getElementById("iframeAdm").src = `https://adm.vemsambar.club/geral.html?a=${pegaPum}`
			}
		);
		
		$('#buttons17 > li:nth-child(2) > a').addEventListener(
			'click',
			function(event) { 
				document.getElementById("iframeAdm").src = `https://adm.vemsambar.club/atividade.html?a=${pegaPum}`
			}
		);
	
	// Buttons: buttons11.
		$('#buttons11 > li:nth-child(1) > a').addEventListener(
			'click',
			function(event) { 
				document.getElementById("iframeAdm").src = `https://euques.github.io/inova/geral.html?a=${diaEventoBd}`
			}
		);
	
	// Buttons: buttons06.
		$('#buttons06 > li:nth-child(2) > a').addEventListener(
			'click',
			function(event) { 
				window.open(
				`https://lista.vemsambar.club/?p=${pegaPum}`
				, '_top')
			}
		);
		
		$('#buttons06 > li:nth-child(4) > a').addEventListener(
			'click',
			function(event) { 
				event.preventDefault();
				event.stopPropagation();
		...
		$('#buttons06 > li:nth-child(5) > a').addEventListener(
			'click',
			function(event) { 
				event.preventDefault();
				event.stopPropagation();
	...
	// Buttons: buttons08.
		$('#buttons08 > li:nth-child(1) > a').addEventListener(
			'click',
			function(event) { 
				navLogin.innerHTML = "Área da Hostess "
			}
		);
	
	// Buttons: buttons12.
		$('#buttons12 > li:nth-child(1) > a').addEventListener(
			'click',
			function(event) { 
				navLogin.innerHTML = "Área do Promoter "
			}
		);
